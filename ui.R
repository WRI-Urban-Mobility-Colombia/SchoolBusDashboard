        ...
        div(
          ...
          bsCollapse(
            ...
            bsCollapsePanel("1. ¿Qué es la herramienta?", 
                            p("Esta herramienta tiene como objetivo facilitar la toma de decisioes a través de los datos"),
                            ...
                            br(),
                            p("Permite revisar las propuestas de electrificación realizadas por el equipo de WRI Colombia, así como sus datos operacionales, población beneficiada e impacto ambiental"),
                            style = "primary"),
            bsCollapsePanel("2. Módulos de la herramienta", 
                            p("La herramienta contiene 2 módulos"),
                            h3(strong(em("Explore las propuestas"))),
                            p("Este módulo permite explorar el impacto de las propuestas planteadas por el equipo, parten de la hipótesis de habilitar la carga de la flota en los patios de buses eléctricos existentes"),
                            br(),
                            h3(strong(em("Diseñe el proyecto"))),
                            p("Aquí se pueden diseñar sus propios proyectos e identificar su impacto, para ello, se debe seleccionar los hexágonos que componen el proyecto dando click en los hexágonos, los cuales irán totalizando las rutas y su impacto"),
                            br(),
                            h4(strong(em("Filtros"))),
                            p("Si se desesa, el proyecto puede diseñarse o enfocarse en un tipo de vehículo o tipo de ruta, para ello se puede usar el panel de filtro al costado derecho"),
                            style = "primary"),
            bsCollapsePanel("3. Resultados", 
                            p("Una vez se selecciona un proyecto, o una serie de hexágonos, la herramienta genera una serie de resultados que se ubican debajo del mapa, estos resultados son:"),
                            h3(strong(em("Panel de beneficiarios"))),
                            hr(),
                            h4(em("Beneficiarios atendidos por colegio")),
                            p("Totaliza los estudiantes beneficiarios por institución educativa pertenecientes al grupo de rutas seleccionado"),
                            br(),
                            h4(em("Beneficiarios atendidos por tipo de vehículo")),
                            p("Totaliza los estudiantes beneficiarios por tipo de ruta y vehículo pertenecientes al grupo de rutas seleccionado"),
                            h3(strong(em("Panel de operación"))),
                            hr(),
                            p("Esta sección presenta los principales indicadores operacionales a tener en cuenta al diseñar el proyecto"),
                            h4(em("Reporte por colegio")),
                            p("Muestra las horas totales, rutas asignadas y beneficiarios por colegio cuyas rutas están en el área seleccionada, también interpola la cantidad de vehículos"),
                            h4(em("Listado de rutas a impactar")),
                            p("Lista las rutas que componen la propuesta, señala su código, tipo, vehículo y colegio asignado"),
                            h4(em("Horas contratadas")),
                            p("Totaliza las horas semanales contratadas para el servicio por tipo de ruta y vehículo"),
                            h4(em("Kilómetros semanales")),
                            p("Totaliza los kilómetros semanales  contratadas para el servicio por tipo de ruta y vehículo, incluyen el 26% de distancia en vacío"),
                            h4(em("Rutas")),
                            p("Totaliza el total de rutas contratadas para el servicio por tipo de ruta y vehículo"),
                            h4(em("Vehículos")),
                            p("Estima el total de vehículos necesarios para el servicio por tipo de ruta y vehículo, esta es una aproximación que debe analizarse a nivel operativo por los prestadores del servicio"),
                            h3(strong(em("Panel de Energía y recarga"))),
                            hr(),
                            p("Los resultados de energía y recarga, así como el impacto ambiental dependen de los parámetros operativos. Si se desea, por defecto se estiman los parámetros únicamente considerando los kilómetros escolares, pero se puede agregar kilometros de trabajo adicional"),
                            p("Por defecto, se toman 140Km semanales para el análisis, pero se puede definir"),
                            p("El método de cálculo define los parámetros para estimar la infraestructura de carga, por defecto se toma el promedio diario, equivalente a recargar 5 días a la semana"),
                            p("Cuando se selecciona el factor de carga, se debe definir el número de recargas a la semana"),
                            p("La ventana de recarga define el total de horas que se tienen disponibles para la recarga"),
                            h4(em("Consumo energético")),
                            p("Estima la demanda de servicio de recarga por tipo de vehículo y tipo de ruta. Se definen también las demandas energéticas por servicios adicionales, y se definen con el sufijo '_extra'"),
                            h4(em("Patrones de actividad")),
                            p("Muestra el total de rutas por hora de entrada, permite visualizar la dinámica de las rutas seleccionadas, para validar la ventana de recarga"),
                            h4(em("Datos de recarga")),
                            p("Como resultado, se presenta la energía diaria requerida, la potencia total definida por la ventana de carga y los cargadores de 150kW requeridos"),
                            h3(strong(em("Panel de impacto ambiental"))),
                            hr(),
                            p("El impacto ambiental parte de los kilómetros anuales proyectados para el proyecto, por defecto se parte de los kilómetros semanales +26% en vacío, pero al cambiar los parámetros en energía, se actualizan según los filtros definidos"),
                            h4(em("Emisiones evitadas")),
                            p("La tabla de emisiones presenta el total de emisiones evitadas al año, para todos los contaminantes, las gráficas presentan los resultados de los contaminantes en kilogramos/año y para CO2eq en toneladas/año"),
                            hr(),
                            style = "primary"),
            bsCollapsePanel("4. Créditos y repositorio", 
                            h3(em("Créditos")),
                            hr(),
                            p("El equipo que ideó y llevó a cabo la herramienta es:"),
                            br(),
                            p("Rafael Muñoz"),
                            p("Luis Castro"),
                            h3(em("Repositorio de Github")),
                            hr(),
                            p("El código es accessible en github en este link",
                              tags$a(href = "https://github.com/WRI-Urban-Mobility-Colombia/SchoolBusDashboard", "Repositorio de GitHub", target = "_blank"),
                              "."),
                            p("Si desea los datasets, contactar a",
                              tags$a(href = "mailto:rafael.munoz@wri.org", "Rafael Muñoz")),
                            style = "primary"
                            )
          )
        )
